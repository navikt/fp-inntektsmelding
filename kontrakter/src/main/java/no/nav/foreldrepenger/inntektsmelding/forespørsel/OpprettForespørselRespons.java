...
import no.nav.foreldrepenger.inntektsmelding.felles.ForespørselResultatDto;
...
public record OpprettForespørselRespons(@NotNull List<@Valid OrganisasjonsnummerMedStatus> organisasjonsnumreMedStatus) {
    public record OrganisasjonsnummerMedStatus(@NotNull @Valid OrganisasjonsnummerDto organisasjonsnummerDto, ForespørselResultatDto status) {}
}
