package no.nav.foreldrepenger.inntektsmelding.integrasjoner.metrikker;
...
public class MetrikkerTjeneste {
    ...
    public static void loggInnsendtInntektsmelding(InntektsmeldingDto inntektsmelding) {
        try {
    ...
    private static void forsøkLoggInnsendtInntektsmelding(InntektsmeldingDto inntektsmelding) {
        var tags = new ArrayList<Tag>();
        ...
        var harOppgittEndringerIRefusjon = inntektsmelding.getSøkteRefusjonsperioder() != null && !inntektsmelding.getSøkteRefusjonsperioder().isEmpty();
        ...
        var harOppgittNaturalytelse = inntektsmelding.getBortfaltNaturalytelsePerioder() != null && !inntektsmelding.getBortfaltNaturalytelsePerioder().isEmpty();
        var harEndretInntekt = !inntektsmelding.getEndringAvInntektÅrsaker().isEmpty();

        tags.add(new ImmutableTag(TAG_YTELSE, inntektsmelding.getYtelse().name()));
        ...
        if (!inntektsmelding.getEndringAvInntektÅrsaker().isEmpty()) {
            ...
            endringsårsakerTags.add(new ImmutableTag(TAG_YTELSE, inntektsmelding.getYtelse().name()));
            endringsårsakerTags.add(new ImmutableTag(TAG_AARSAK, inntektsmelding.getEndringAvInntektÅrsaker().stream()
    ...
    public static void logginnsendtArbeidsgiverinitiertNyansattIm(InntektsmeldingDto imEntitet) {
        try {
            var tags = new ArrayList<Tag>();
    ...
    public static void logginnsendtArbeidsgiverinitiertUregistrertIm(InntektsmeldingDto imEntitet) {
        try {
            var tags = new ArrayList<Tag>();
            tags.add(new ImmutableTag(TAG_YTELSE, imEntitet.getYtelse().name()));
