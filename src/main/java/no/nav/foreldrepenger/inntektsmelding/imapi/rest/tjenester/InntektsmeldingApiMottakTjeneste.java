...
public class InntektsmeldingApiMottakTjeneste {
    ...
    private SendInntektsmeldingResponse sjekkMånedInntektMotRapportertInntekt(ForespørselDto forespørsel, InntektsmeldingDto inntektsmelding) {
        ...
        if (resultat instanceof InntektKontrollResultat.Nedetid nedetid) {
            ...
            return new SendInntektsmeldingResponse(true,
                ...
                new SendInntektsmeldingResponse.FeilInfo(FeilkodeDto.NEDETID_AINNTEKT, nedetid.melding(), forespørsel.uuid().toString()));
        }

        if (resultat instanceof InntektKontrollResultat.UlikInntekt ulikInntekt) {
            return new SendInntektsmeldingResponse(false,
                null, null,
                new SendInntektsmeldingResponse.FeilInfo(FeilkodeDto.ULIK_INNTEKT, ulikInntekt.feilmelding(), forespørsel.uuid().toString()));
        }
