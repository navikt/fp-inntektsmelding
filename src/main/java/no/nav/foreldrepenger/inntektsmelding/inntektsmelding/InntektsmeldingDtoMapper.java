...
public class InntektsmeldingDtoMapper {
    ...
    public static InntektsmeldingDto mapFraEntitet(InntektsmeldingEntitet entitet) {
        return InntektsmeldingDto.builder()
            ...
            .medBortfaltNaturalytelsePerioder(entitet.getBorfalteNaturalYtelser()
                .stream()
    ...
    // ---- Dto -> Entitet ----
    public static InntektsmeldingEntitet mapTilEntitet(InntektsmeldingDto inntektsmeldingDto, ForespørselEntitet forespørselEntitet) {
        return map(inntektsmeldingDto, forespørselEntitet);
    }

    // ---- Dto -> Entitet ----
    public static InntektsmeldingEntitet mapTilEntitetUtenKoblingMotForespørsel(InntektsmeldingDto inntektsmeldingDto) {
        return map(inntektsmeldingDto, null);
    }

    private static InntektsmeldingEntitet map(InntektsmeldingDto inntektsmeldingDto, ForespørselEntitet forespørselEntitet) {
        var builder = InntektsmeldingEntitet.builder()
            ...
            .medRefusjonsendringer(mapRefusjonsendringer(inntektsmeldingDto.getStartdato(),
                inntektsmeldingDto.getOpphørsdatoRefusjon(),
                inntektsmeldingDto.getSøkteRefusjonsperioder()))
        ...
        if (forespørselEntitet != null) {
            builder.medForespørsel(forespørselEntitet);
        }
