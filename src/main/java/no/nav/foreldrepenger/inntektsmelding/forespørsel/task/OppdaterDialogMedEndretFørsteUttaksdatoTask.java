...
public class OppdaterDialogMedEndretFørsteUttaksdatoTask implements ProsessTaskHandler {
    ...
    public void doTask(ProsessTaskData prosessTaskData) {
        ...
        if (!førsteUttaksdato.equals(forespørsel.førsteUttaksdato())) {
            LOG.info("Første uttaksdato er endret igjen for forespørsel {}, oppdaterer ikke dialog", forespørselUuid);
            return;
        }
        ...
        dialogportenTjeneste.utførMotDialogportenMedDevToleranse(
            () -> dialogportenTjeneste.oppdaterDialogMedEndretFørsteUttaksdato(forespørsel, sisteEndring.førsteUttaksdato(), førsteUttaksdato));
