...
@ApplicationScoped
@RestClientConfig(tokenConfig = TokenFlow.AZUREAD_CC, endpointProperty = "hentinntektlistebolk.url",
    endpointDefault = "https://ikomp.prod-fss-pub.nais.io/rs/api/v1/hentinntektlistebolk",
    scopesProperty = "hentinntektlistebolk.scopes", scopesDefault = "api://prod-fss.team-inntekt.ikomp/.default")
public class InntektskomponentKlient {
    ...
    private RestRequest lagRequest(FinnInntektRequest finnInntektRequest) {
        ...
        request.setFormaal("Foreldrepenger");
