...
class ForespørselTekster {
    ...
    private static final String BESKJED_OM_KVITTERING_TEKST = "Kopi av innsendt inntektsmelding.";
    ...
    public static String lagBeskjedOmKvitteringTekst() {
        return String.format(BESKJED_OM_KVITTERING_TEKST);
    }
