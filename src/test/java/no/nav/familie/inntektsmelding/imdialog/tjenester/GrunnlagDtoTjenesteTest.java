...
class GrunnlagDtoTjenesteTest {
    ...
    void skal_lage_DialogDto() {
        ...
        when(personTjeneste.hentPersonInfoFraAktørId(new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(forespørsel.getAktørId().getAktørId()), forespørsel.getYtelseType())).thenReturn(
            new PersonInfo("Navn", null, "Navnesen", personIdent, new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(forespørsel.getAktørId().getAktørId()), stp, null, null));
        ...
        assertThat(imDialogDto.person().aktørId()).isEqualTo(new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(forespørsel.getAktørId().getAktørId()).getAktørId());
    ...
    void skal_lage_dto_med_første_uttaksdato() {
        ...
        when(organisasjonTjeneste.finnOrganisasjon(forespørsel.getOrganisasjonsnummer())).thenReturn(
            new Organisasjon("Bedriften", forespørsel.getOrganisasjonsnummer()));
        var personIdent = new PersonIdent("12121212122");
        when(personTjeneste.hentPersonInfoFraAktørId(new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(forespørsel.getAktørId().getAktørId()).getAktørId()), forespørsel.getYtelseType())).thenReturn(
            new PersonInfo("Navn", null, "Navnesen", personIdent, new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(forespørsel.getAktørId().getAktørId()).getAktørId()), stp, null, null));
        var innsenderNavn = "Ine";
        var innsenderEtternavn = "Sender";
        var innsenderTelefonnummer = "+4711111111";
        when(personTjeneste.hentPersonFraIdent(PersonIdent.fra(INNMELDER_UID), forespørsel.getYtelseType())).thenReturn(
    ...
    void skal_hente_arbeidsforhold_gitt_fnr() {
        ...
        var aktørId = new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId("9999999999999");
    ...
    void skal_lage_arbeidsgiverinitiert_nyansatt_dialog_ny() {
        ...
        var personInfo = new PersonInfo("Navn", null, "Navnesen", fødselsnummer, new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(aktørId.getAktørId()), LocalDate.now(), null, PersonInfo.Kjønn.MANN);
    ...
    void skal_rute_til_eksisterende_forespørsel_hvis_finnes_når_arbeidsgiverinitiert_nyansatt() {
        ...
        var personInfo = new PersonInfo("Navn", null, "Navnesen", personIdent, new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(aktørId.getAktørId()), LocalDate.now(), null, null);

        when(personTjeneste.hentPersonFraIdent(personIdent, ytelsetype)).thenReturn(personInfo);
        when(personTjeneste.hentPersonInfoFraAktørId(new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(aktørId.getAktørId()), ytelsetype)).thenReturn(personInfo);
        when(personTjeneste.hentPersonFraIdent(PersonIdent.fra(INNMELDER_UID), ytelsetype)).thenReturn(
    ...
    void skal_gi_eksisterende_forespørsel_med_ansettelsesperioder_hvis_finnes_for_arbeidsgiver_nyansatt() {
        ...
        var personInfo = new PersonInfo("Navn", null, "Navnesen", fødselsnummer, new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(aktørId.getAktørId()), LocalDate.now(), null, null);
    ...
    void skal_lage_arbeidsgiverinitiert_uregistrert_dialog_ny() {
        ...
        var personInfo = new PersonInfo("Navn", null, "Navnesen", personIdent, new no.nav.familie.inntektsmelding.integrasjoner.person.AktørId(aktørId.getAktørId()), LocalDate.now(), null, PersonInfo.Kjønn.MANN);
